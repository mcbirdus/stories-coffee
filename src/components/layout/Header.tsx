...
const Header = () => {
  ...
  return (
    ...
    >
      {/* Enhanced App coming soon banner with rounded corners - Added margin-bottom */}
      <div className="bg-gradient-to-r from-stories-green to-stories-green/80 text-white py-3 px-4 text-center relative overflow-hidden rounded-md mb-3">
